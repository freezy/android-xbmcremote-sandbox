...
public class AudioContract {
	...
	public static class Albums implements AlbumsColumns, BaseColumns {
		...
		/** Read {@link #ID} from {@link org.xbmc.android.jsonrpc.provider.AudioContract.Albums} {@link Uri}. */
	...
	public static class Artists implements ArtistsColumns, BaseColumns {
		...
		/** Count of {@link Albums} for a given {@link org.xbmc.android.jsonrpc.provider.AudioContract.Artists}. */
		...
		/** Read {@link #ID} from {@link org.xbmc.android.jsonrpc.provider.AudioContract.Artists} {@link Uri}. */
